...
\begin{@twocolumnfalse}
  ...
  \textbf{Keywords}: Outcome Reporting Bias (ORB); ORB-adjustment; Selection Model; Selection Function; Meta-analysis.\\
  \end{abstract}
\end{@twocolumnfalse}
]
...
%\hline
<<echo=FALSE, results='asis', fig.height=10, fig.width=9, message=FALSE, warning=FALSE>>=
