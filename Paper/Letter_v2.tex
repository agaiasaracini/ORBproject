...
\textcolor{blue}{
  To facilitate the review of changes, we have included marked-up versions of the main article and the supplementary material using \texttt{latexdiff}. These documents highlight the differences between the original submission %%, i.e., \texttt{ORB2.pdf}, \texttt{Supplementary.pdf},
